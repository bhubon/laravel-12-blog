                            ...
                            <form method="POST" action="{{ route('posts.update',$post) }}" class="mt-6"
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="content" id="content" rows="4"
                                        class="w-full mt-1 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('content',$post->content) }}</textarea>
                                    @error('description')
                                        <span class="text-sm text-red-600">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="meta_description" id="meta_description"
                                        class="w-full mt-1 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('meta_description',$post->meta_description) }}</textarea>
                                    ...
                                    <select name="status" id="status"
                                        ...
                                        @foreach ($status as $statusKey => $statusValue)
                                            <option value="{{ $statusValue }}"
                                                {{ old('status',$post->status) == $statusValue->value ? 'selected' : '' }}>
